...
if (env('APP_ENV') == 'live') {
    ...
    // $urlConnectServicePlatform = 'http://10.130.254.18:9097';
    $urlConnectServicePlatform = 'http://174.138.29.128:9097';
//    $urlConnectServicePlatform = 'https://api.monkeyuni.com/lesson';
    $urlConnectServiceApp      = 'https://api.monkeyuni.net/';
    $urlConnectServiceMedia    = 'https://www.media.monkeyuni.net';
    ...
    $urlConnectServiceLms      = 'https://lms.monkeyuni.net/';
    // $urlConnectServicePlatform = 'https://api.dev.daybehoc.com/';
    // $urlConnectServicePlatform = 'http://10.130.210.65:9097';
    $urlConnectServicePlatform = 'http://174.138.29.128:9097';
    $urlConnectServiceApp      = 'https://api.dev.monkeyuni.net/';
    ...
    $urlConnectServicePlatform = 'https://api.dev.daybehoc.com/';
    $urlConnectServiceApp      = 'https://api.dev.daybehoc.com/';
    $urlConnectServiceMedia    = 'https://www.media.monkeyuni.net';
...
return [
    ...
    'API_SERVICE_PLATFORM'=> $urlConnectServicePlatform,
